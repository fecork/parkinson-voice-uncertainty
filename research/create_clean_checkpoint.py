#!/usr/bin/env python3
"""
Script para crear un checkpoint limpio y compatible.
"""
...
def create_clean_checkpoint():
    """Crear un checkpoint limpio y compatible."""

    print("=" * 70)
    print("CREANDO CHECKPOINT LIMPIO Y COMPATIBLE")
    print("=" * 70)
    ...
    # Datos de trials compatibles (solo los mejores)
    compatible_trials = {
        "0": {
            "number": 0,
            "state": "COMPLETE",
    ...
    print(f"📊 Creando checkpoint con {len(compatible_trials)} trials")
    ...
    print(f"\n✅ Checkpoint limpio creado:")
    print(f"   - Trials: {len(compatible_trials)}")
    ...
    print("\n🚀 ¡Checkpoint limpio creado! Ahora puedes continuar con Optuna")
    print("=" * 70)
