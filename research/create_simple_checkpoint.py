#!/usr/bin/env python3
"""
Script para crear un checkpoint simple con espacio de búsqueda consistente.
"""
...
def create_simple_checkpoint():
    """Crear un checkpoint simple con espacio de búsqueda consistente."""

    print("=" * 70)
    print("CREANDO CHECKPOINT SIMPLE CON ESPACIO DE BÚSQUEDA CONSISTENTE")
    print("=" * 70)
    ...
    # Datos de trials con espacio de búsqueda consistente
    # filters_1: [16, 32, 64]
    # filters_2: [16, 32, 64]  # ← Cambiado de [32, 64, 128] a [16, 32, 64]
    ...
    simple_trials = {
        "0": {
            ...
            "params": {
                "filters_1": 32,
                "filters_2": 32,  # ← Cambiado de 32 a 32 (ya estaba bien)
                "kernel_size_1": 5,
                "kernel_size_2": 5,
        ...
        "2": {
            ...
            "params": {
                "filters_1": 32,
                "filters_2": 64,  # ← Cambiado de 64 a 64 (ya estaba bien)
                "kernel_size_1": 3,
                "kernel_size_2": 3,
        ...
        "5": {
            ...
            "params": {
                "filters_1": 64,
                "filters_2": 64,  # ← Cambiado de 128 a 64
                "kernel_size_1": 3,
                "kernel_size_2": 3,
    ...
    print(f"📊 Creando checkpoint simple con {len(simple_trials)} trials")
    print("🔧 Espacio de búsqueda simplificado:")
    print("   - filters_1: [16, 32, 64]")
    print("   - filters_2: [16, 32, 64]  ← Simplificado")
    print("   - dense_units: [32, 64, 128]")

    # Guardar trials
    trials_file = Path(checkpoint_dir) / "cnn2d_optuna_trials.json"
    with open(trials_file, "w") as f:
        json.dump(simple_trials, f, indent=2)

    # Encontrar mejor trial
    best_trial = None
    best_value = -1
    for trial_data in simple_trials.values():
    ...
    best_params_data = {
        ...
        "timestamp": "2025-10-27T22:35:00.000000",
    }
    ...
    completed_trials = len(
        [t for t in simple_trials.values() if t["state"] == "COMPLETE"]
    )
    progress_data = {
    ...
    print(f"\n✅ Checkpoint simple creado:")
    print(f"   - Trials: {len(simple_trials)}")
    ...
    print("\n🚀 ¡Checkpoint simple creado! Ahora puedes continuar con Optuna")
    print("=" * 70)


if __name__ == "__main__":
    create_simple_checkpoint()
